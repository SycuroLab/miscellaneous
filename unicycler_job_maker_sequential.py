...
with open(sample_file,'r') as file:
    ...
    for line in lines:
        line = line.strip()
        output_file.write("unicyler -1 "+input_path+str(line)+illumina_suffix+"_1"+file_extension+" -2"+input_path+str(line)+illumina_suffix+"_2"+file_extension+" --mode "+mode+" --threads "+str(num_threads)+" --keep 2 --depth_filter "+str(depth_filter)+" --min_fasta_length "+str(min_contig_length)+" --out "+dir_out+
"_"+line+"\n")
